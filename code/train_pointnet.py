...
class LitModel(pl.LightningModule):
    def __init__(self, dropout, lr, batch_size, epochs, warm_up, optimizer):
        super().__init__()
...
def run(lr=1e-3,
    ...
    model = LitModel(dropout=dropout, batch_size=batch_size, epochs=epochs, lr=lr, warm_up=warm_up,
                     optimizer=optimizer)
